 ...
 * of this value object you may modify the generated sub-class of this class - Media_restriction.as.
 */
...
[ExcludeClass]
public class _Super_Media_restriction extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _Media_restrictionEntityMetadata;

    /**
     * properties
     */
    private var _internal_type : String;
    private var _internal_relationship : String;
    private var _internal_restriction : String;
    ...
    public function _Super_Media_restriction()
    {
        _model = new _Media_restrictionEntityMetadata(this);
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "restriction", model_internal::setterListenerRestriction));
    ...
    {
        var oldValue:String = _internal_relationship;
        if (oldValue !== value)
        {
    ...
    {
        var oldValue:String = _internal_restriction;
        if (oldValue !== value)
        {
            _internal_restriction = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "restriction", oldValue, _internal_restriction));
        }
    }
    ...
    model_internal function setterListenerRestriction(value:flash.events.Event):void
    {
        _model.invalidateDependentOnRestriction();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.restrictionIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_restrictionValidationFailureMessages);
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _Media_restrictionEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _Media_restrictionEntityMetadata) : void
    {
        var oldValue : _Media_restrictionEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationLastValOfRelationship : String;
    ...
    model_internal var _doValidationCacheOfRestriction : Array = null;
    model_internal var _doValidationLastValOfRestriction : String;

    model_internal function _doValidationForRestriction(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfRestriction != null && model_internal::_doValidationLastValOfRestriction == value)
           return model_internal::_doValidationCacheOfRestriction ;

        _model.model_internal::_restrictionIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isRestrictionAvailable && _internal_restriction == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "restriction is required"));
        }

        model_internal::_doValidationCacheOfRestriction = validationFailures;
        model_internal::_doValidationLastValOfRestriction = value;
