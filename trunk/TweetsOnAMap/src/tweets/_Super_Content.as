...
[ExcludeClass]
public class _Super_Content extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _ContentEntityMetadata;
    ...
    {
        var oldValue : _ContentEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
