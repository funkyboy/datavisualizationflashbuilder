...
[ExcludeClass]
public class _Super_Author extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _AuthorEntityMetadata;
    ...
    {
        var oldValue : _AuthorEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
